...
RectButtonFont = pygame.font.Font("OpenSans-Regular.ttf", 22)
...
start_button = RectButton(
                        ...
                        width=3.8*PADDING, height=1.5*PADDING,
                        text="Search path", textcolor=colors["black"],
                        rectcolor=colors["frontier"],screen=screen,font=RectButtonFont)

draw_button = RectButton(
                        left=5*PADDING, top=height-2*PADDING,
                        width=3.7*PADDING, height=1.5*PADDING,
                        text="Draw Wall", textcolor=colors["black"],
                        rectcolor=colors["frontier"],screen=screen,font=RectButtonFont)

erase_button = RectButton(
                        left=9*PADDING, top=height-2*PADDING,
                        width=3.8*PADDING, height=1.5*PADDING,
                        text="Erase Wall", textcolor=colors["black"],
                    rectcolor=colors["frontier"],screen=screen,font=RectButtonFont)

maze_button = RectButton(
                        left=13*PADDING, top=height-2*PADDING,
                        width=4.7*PADDING, height=1.5*PADDING,
                        text="Random Maze", textcolor=colors["black"],
                        rectcolor=colors["frontier"],screen=screen,font=RectButtonFont)

reset_button = RectButton(
                        left=18*PADDING, top=height-2*PADDING,
                        width=3*PADDING, height=1.5*PADDING,
                        text="Reset", textcolor=colors["black"],
                        rectcolor=colors["red"],screen=screen,font=RectButtonFont)

dijkstra_button = CirButton(
                            center=(24*PADDING+10,3*PADDING), radius=RADIUS, text="D",
                            textcolor=colors["black"], circolor=colors["white"],
                            screen=screen, font=CirButtonFont)

bfs_button = CirButton(
                        center=(24*PADDING+10,6*PADDING), radius=RADIUS, text="B",
                        textcolor=colors["black"], circolor=colors["white"],
                        screen=screen, font=CirButtonFont)

asearch_button = CirButton(
                            center=(24*PADDING+10,9*PADDING), radius=RADIUS, text="A",
                            textcolor=colors["black"], circolor=colors["white"],
                            screen=screen, font=CirButtonFont)

qlearning_button = CirButton(
                            center=(24*PADDING+10,12*PADDING), radius=RADIUS, text="Q_D",
                            textcolor=colors["black"], circolor=colors["white"],
                            screen=screen, font=CirButtonFont)
